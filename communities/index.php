...
<section style="background-image: url(/images/background/GettyImages-849237828.jpg);" class="bg-center" id="community-list">
	<div class="container-fluid">
		<div class="row com-bg-green pt-5">
			<div class="col-md-12">
				...
				<div class="switchWrap mt-3 row justify-content-between align-items-center no-margin">
					<div class="d-flex mb-3">
						...
						<div class="d-flex flex-wrap">
							...
							<div>
								<select id="select-county" class="mdb-select mdb-select-county md-form md-custom-select" disabled>
					...
					<div class="container-fluid">
						<div id="filterContainer" class="row listingsWrap">
							...
							for ($k = 0; $k < sizeof($communities); $k++) {
							 ...
							 ?>
							<div id="community-<?php echo $k; ?>" class="col-xl-3 col-lg-4 col-sm-6 no-padding listWrap" data-name="<?php echo $communities[$k]['name']; ?>" data-state="<?php echo $communities[$k]['county'][1]; ?>" data-county="<?php echo $communities[$k]['county'][0]; ?>">
								<div class="listings-column z-depth-1-half">
									<div class="view">
										<img src="images/communities/<?php echo $communities[$k]['image']; ?>" class="img-fluid w-100 img-fit">
										<div class="mask listings">
											...
											<p class="text-white desc fadeIn"><?php echo $communities[$k]['desc']; ?></p>
											<?php } ?>
											<?php if ($communities[$k]['website'] != "") { ?>
											<a href="<?php echo $communities[$k]['website']; ?>" target="_blank" class="btn-custom desc fadeIn animated">VISIT US <img src="/images/arrow-right.svg" width="10px;" class="vertical-align-center"></a>
											<?php } ?>
											<?php if ($communities[$k]['video'] != "") { ?>
											<a href="<?php echo $communities[$k]['video']; ?>" target="_blank" class="btn-custom desc fadeIn animated">VIDEO&nbsp;&nbsp;&nbsp;&nbsp; <img src="/images/arrow-right.svg" width="10px;" class="vertical-align-center"></a>
											<?php } ?>
											<div class="direction-btn">
												<a target="_blank" href="https://www.google.com/maps/dir/?api=1&destination=<?php echo $communities[$k]['coords'][0]; ?>,<?php echo $communities[$k]['coords'][1]; ?>">
							...
							<?php if ($k == 3) { ?>
							<div class="col-xl-6 col-md-8 col-sm-12 no-padding align-self-xl-start align-self-sm-center" id="testimonials-1Wrap">
							...
							<?php } ?>
							<?php if ($k == 7) { ?>
							<div class="col-xl-6 col-md-8 col-sm-12 no-padding align-self-xl-start align-self-sm-center" id="testimonialsWrap-2Wrap">
						...
						<div class="row listingsWrap">
							<div class="col-sm-12 px-sm-0">
								<div class="com-content community-content pl-0 pt-0 my-3">
									<h2 class="text-white">COMMUNITIES</h2>
									<h1 class="g-orange">RECENTLY COMPLETED</h1>
									<div class="underline dash-orange mt-2"></div>
								</div>
							</div>
						</div>
						<div id="filterContainerRecentlyCompleted" class="row listingsWrap">
							<?php 
							for ($k = 0; $k < sizeof($communities); $k++) {
								if ($communities[$k]['status'] == "Recently Completed") {
							 ?>
							<div id="community-<?php echo $k; ?>" class="col-xl-3 col-lg-4 col-sm-6 no-padding listWrap" data-name="<?php echo $communities[$k]['name']; ?>" data-state="<?php echo $communities[$k]['county'][1]; ?>" data-county="<?php echo $communities[$k]['county'][0]; ?>">
								<div class="listings-column z-depth-1-half">
									<div class="view">
							...
							<?php } }?>
							<div class="col-md-12 text-white recentlyCompletedResult" style="display: none; font-size: 20px;">No Results</div>
						</div>
					</div>
				</div>
		...
		<div class="row vh-100 com-bg-green p-relative">
			<div class="col-md-12 align-self-sm-end align-self-start">
				<div class="com-content desktop-spacing mb-0 mb-md-5">
					<h2 class="text-white">BUY OR RENT-IT'S</h2>
					<h1 class="g-purple">YOUR CHOICE</h1>
					...
					<p class="text-white mt-2">Our award-winning apartment communities provide convenient, carefree living in amenity-rich settings that are close to major employment centers.</p>
					<div class="link waves-effect">
...
<section style="background-image: url(/images/background/GettyImages-909457386.jpg);" class="bg-center">
	<div class="container-fluid">
		<div class="row vh-100 com-bg-purple p-relative">
			<div class="col-md-12 align-self-sm-end align-self-start">
				<div class="com-content desktop-spacing mb-0 mb-md-5">
					<h2 class="text-white">MIXED-USE</h2>
					<h1 class="g-orange">LIFESTYLE</h1>
					<div class="underline dash-red mt-2"></div>
					<p class="text-white mt-2">Many of the larger communities that we develop incorporate a carefully planned mix of uses including shopping, dining, and entertainment. These sophisticated walkable neighborhoods increasingly attract both homebuyers and renters.</p>
					<div class="link waves-effect">
...
<section style="background-image: url(/images/background/20140504_Gibsons-Grant_0402.jpg);" class="bg-center">
	<div class="container-fluid">
		<div class="row vh-100 com-bg-green p-relative">
			<div class="col-md-12 align-self-sm-end align-self-start">
				<div class="com-content desktop-spacing mb-0 mb-md-5">
					<h2 class="text-white">COME HOME TO</h2>
					<h1 class="g-green">ELM STREET</h1>
					<div class="underline dash-green mt-2"></div>
					<p class="text-white mt-2">Whether it’s affordable waterfront living near the Chesapeake Bay or a cozy condo in an exciting urban setting, Elm Street Communities offers a wide range of for-sale homes in our new communities located in the Baltimore/Washington corridor. We partner with leading national and regional homebuilders to bring you state-of-the-art home options and designs.</p>
					<!-- <div class="p-relative">
